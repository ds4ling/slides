...
p50 <- normalp50 + 
  geom_area(data = normalp50_build, show.legend = FALSE, 
    alpha = 0.4, aes(x = x, y = y, fill = to_shade)) + 
  scale_fill_manual(name = NULL, values = c("white", "lightblue")) + 
  geom_hline(yintercept = 0, linewidth = 1) + 
  geom_segment(x = 80, xend = 80, y = 0, yend = max(normalp50_build$y), lty = 2) 
...
p5a <- normalp5a + geom_area(data = normalp5a_build, show.legend = FALSE, 
  ...
  scale_fill_manual(name = NULL, values = c("white", "lightblue")) + 
  geom_hline(yintercept = 0, linewidth = 1) + 
  geom_segment(x = 0, xend = 0, y = 0, yend = max(normalp5a_build$y), lty = 2) 
...
p5b <- normalp5b + geom_area(data = normalp5b_build, show.legend = FALSE, 
  ...
  scale_fill_manual(name = NULL, values = c("white", "lightblue")) + 
  geom_hline(yintercept = 0, linewidth = 1) + 
  geom_segment(x = 0, xend = 0, y = 0, yend = max(normalp5b_build$y), lty = 2) + 
...
q3_x2_ht <- as.data.frame(q3_build[q3_build$x >= 2.32 & 
...
---
background-image: url(https://www.jvcasillas.com/media/rstats/memes/rstats_pvalues.png)
background-size: 500px
background-position: 20% 50%
count: false

---
background-image: url(https://www.jvcasillas.com/media/rstats/memes/rstats_pvalues.png), url(https://www.jvcasillas.com/media/rstats/memes/rstats_nhst3.png)
...
```{r}
#| label: tiktok1
t1_url <- "https://www.tiktok.com/@chelseaparlettpelleriti/video/6821961902101466374"
...
```{r}
#| label: tiktok2
t2_url <- "https://www.tiktok.com/@chelseaparlettpelleriti/video/7073346137440439598"
...
```{r}
#| label: tiktok3
t3_url <- "https://www.tiktok.com/@chelseaparlettpelleriti/video/7073335593823898923"
t3 <- tiktok_embed(t3_url)
t3
...
---
background-image: url(https://www.jvcasillas.com/media/rstats/memes/power.png)
background-size: contain
count: false
...
---
background-image: url(https://www.jvcasillas.com/media/rstats/memes/rstats_nhst1.png)
background-size: contain
count: false

---
background-image: url(https://www.jvcasillas.com/media/rstats/memes/rstats_nhst2.png)
background-size: contain
count: false

---
background-image: url(https://www.jvcasillas.com/media/rstats/memes/rstats_pvalues_wrong.png)
background-size: contain
count: false
...
mutate(ind_samp, group  = cell_spec(
  group, "html", color = 'white', 
...
```{r}
#| label: paired-long-table
#| results: 'asis'
mutate(prd_samp_long, 
  test  = cell_spec(test, "html", color = 'black', 
  background = factor(test, c("test1", "test2"), c("coral", "lightskyblue"))),
  name  = cell_spec(name, "html", color = 'white', 
  background = factor(name, c("Mike", "Melanie", "Melissa", "Mitchell"), 
...
---
background-image: url( https://www.jvcasillas.com/media/rstats/memes/rstats_type12_error1.png)
background-size: contain
count: false

---
background-image: url( https://www.jvcasillas.com/media/rstats/memes/rstats_type12_error2.png)
background-size: contain
count: false
