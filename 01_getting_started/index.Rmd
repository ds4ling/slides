...
```{r, 'load-helpers', echo=F, message=F, warning=F}
...
```{r, stats-example, warning=FALSE, message=FALSE, fig.retina=2, fig.height=5}
...
we are writing. Everyting is together, in a single document (usually).  
...
- You will receive an email with an invitation link to join the course Slack ([www.ru-datasci4ling.slack.com](https://join.slack.com/t/ru-datasci4ling/shared_invite/zt-kx9sghzo-teEa8XE92ACYEeCrDlbh4A))

- For personal matters (only) you can email the professor.

- Need help? [Instructions](https://ds4ling.github.io/sources/tuts/slack_setup/index.html)
...
- Need help? [Instructions](https://ds4ling.github.io/sources/tuts/r_install/index.html)
]
...
- Need help? [Instructions](https://ds4ling.github.io/sources/tuts/rstudio_install/index.html)
...
- .blue[ds4ling]: Functions and datasets used in this course
...
- Need help? [Instructions](https://ds4ling.github.io/sources/tuts/github_setup/index.html)
...
[here]: https://ds4ling.github.io/sources/tuts/index.html
