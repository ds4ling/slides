...
ggplot(data = ., aes(x = x, y = y, label = label, color = label)) + 
  ...
  scale_y_continuous(breaks = seq(-5, 5, 1), labels = seq(-5, 5, 1)) +
  geom_vline(xintercept = 0) + 
  geom_hline(yintercept = 0) + 
  geom_segment(data = y_hashes, show.legend = FALSE, 
    aes(x = x, xend = x_end, y = y_axis, yend = y_axis, label = NULL, 
        color = NULL)) +
  geom_segment(data = x_hashes, show.legend = FALSE, 
    aes(x = x_axis, xend = x_axis, y = y, yend = y_end, label = NULL, 
        color = NULL)) +
...
layout: false
class: title-slide-section-grey, middle
background-image: url(https://www.jvcasillas.com/media/rstats/memes/lm_general.png)
...
coords_p2 <- ggplot(coords_p2_labels, aes(x = x, y = y, label = label)) + 
  geom_text(size = 6, show.legend = FALSE) + 
  geom_point(data = coords_p2_points,  aes(x = x, y = y, label = NULL), 
    color = "blue", size = 3) +
  scale_x_continuous(breaks = seq(-5, 5, 1), labels = seq(-5, 5, 1)) + 
  scale_y_continuous(breaks = seq(-5, 5, 1), labels = seq(-5, 5, 1)) +
  geom_vline(xintercept = 0) + 
  ...
  geom_segment(data = x_hashes, show.legend = FALSE, 
    aes(x = x_axis, xend = x_axis,  y = y, yend = y_end, label = NULL, 
        color = NULL)) + scale_color_brewer(palette = "Set1") +
  ds4ling_bw_theme(base_size = 20, base_family = 'Times')
...
ggplot(coords_p2_points, aes(x = x, y = y)) + 
  ...
  geom_vline(xintercept = 0) + 
  geom_hline(yintercept = 0) + 
  geom_hline(yintercept = mean(coords_p2_points$y), lty = 1, color = 'blue', 
    linewidth = 1.5) +
  geom_abline(intercept = 0, slope = 1, lty = 2, color = "darkred") + 
  geom_segment(aes(x = 1, xend = 1, y = 1, yend = 2), lty = 3, linewidth = 1) + 
  geom_segment(aes(x = 3, xend = 3, y = 2, yend = 3), lty = 3, linewidth = 1) + 
...
imperf_plot1 <- ggplot(imperf_points1, aes(x = x, y = y)) + 
  ...
  geom_abline(intercept = 0.5, slope = 1.1, lty = 2, color = "darkred") + 
  geom_segment(aes(xend = x, yend = fitted1), lty = 3, linewidth = 1) +
  geom_point(color = 'blue', fill = 'grey70', pch = 21, size = 6) + 
  ds4ling_bw_theme(base_size = 20, base_family = 'Times')
...
imperf_plot2 <- ggplot(imperf_points1, aes(x = x, y = y)) + 
  ...
  geom_hline(yintercept = mean(imperf_points1$y), 
    lty = 1, color = 'blue', linewidth = 1.5, alpha = 0.1) +
  geom_abline(intercept = 0.25, slope = 0.5, lty = 2, color = "darkred") +
  geom_segment(aes(xend = x, yend = fitted2), lty = 3, linewidth = 1) +
  geom_point(color = 'blue', fill = 'grey70', pch = 21, size = 6) + 
  ds4ling_bw_theme(base_size = 20, base_family = 'Times')
...
imperf_plot3 <- ggplot(imperf_points1, aes(x = x, y = y)) + 
  ...
  geom_abline(intercept = coef(imperf_mod)[1], slope = coef(imperf_mod)[2], 
    lty = 2, color = "darkred") + 
  geom_segment(aes(xend = x, yend = fitted(imperf_mod)), lty = 3, 
    linewidth = 1) +
  geom_point(color = 'blue', fill = 'grey70', pch = 21, size = 6) + 
  ds4ling_bw_theme(base_size = 20, base_family = 'Times')
...
#| label: best_fit7
imperf_plot1 + 
  annotate("text", x = 0.85, y = 1.85, label = "[", lwd = 14, color = 'grey70') +
...
imperf_table1 %>% 
  add_row(y_hat = NA) %>% 
  add_row(y_hat = NA, pred.error = pred_error1, sqrd.error = sqrd_error1) %>%
...
imperf_table2 %>% 
  add_row(y_hat = NA) %>% 
  add_row(y_hat = NA, pred.error = pred_error2, sqrd.error = sqrd_error2) %>%
  mutate(x_i = cell_spec(x_i, "html", 
    color = if_else(is.na(x_i), "white", "black")), 
    y_i = cell_spec(y_i, "html", 
    color = if_else(is.na(y_i), "white", "black")), 
...
imperf_plot_bestfit <- ggplot(imperf_points1, aes(x = x, y = y)) + 
  ...
  geom_vline(xintercept = 0) + 
  geom_hline(yintercept = 0) + 
  geom_hline(yintercept = mean(imperf_points1$y), lty = 1, color = 'blue', 
...
imperf_table3 <- imperf_points1 %>% 
  select(x_i = x, y_i = y) %>% 
  mutate(y_hat = fitted(imperf_mod), pred.error = y_i - y_hat, 
...
imperf_table3 %>% 
  add_row(y_hat = NA) %>% 
  add_row(y_hat = NA, pred.error = pred_error3, sqrd.error = sqrd_error3) %>%
  mutate(x_i = cell_spec(x_i, "html", 
    color = if_else(is.na(x_i), "white", "black")), 
    y_i = cell_spec(y_i, "html", 
    color = if_else(is.na(y_i), "white", "black")), 
...
exp_table %>% 
  ...
  mutate(
    obs = cell_spec(obs, "html", color = if_else(is.na(obs), "white", "black")),
    x = cell_spec(x, "html", color = if_else(is.na(x), "white", "black")),
    y = cell_spec(y, "html", color = if_else(is.na(y), "white", "black")),
...
#| fig.height: 7
imperf_plot_bestfit + 
  annotate("text", x = 1, y = 3, lwd = 7, parse = T, 
...
ggplot(mtcars, aes(x = wt, y = mpg)) + 
  ...
  geom_point(size = 4) + 
  geom_point(size = 3, color = 'lightblue') + 
  geom_hline(yintercept = mean(mtcars$mpg), linewidth = 2, color = 'darkred') +
  annotate('text', 
    x = (mean(mtcars$wt) + 1), 
    y = (mean(mtcars$mpg) + 1), lwd = 6,
...
ggplot(mtcars, aes(x = wt, y = mpg)) + 
  ...
  annotate('text', 
    ...
    y = (mean(mtcars$mpg) + 1), lwd = 6,
    label = 'Mean mpg', color = 'darkred') + 
  stat_smooth(method = 'lm', se = F, color = 'darkblue', lwd = 2, 
    fullrange = TRUE, formula = 'y ~ x') + 
  annotate('text', 
    x = (mean(mtcars$wt) + 1), 
    y = (mean(mtcars$mpg) - 2), lwd = 6,
...
ggplot(mtcars, aes(x = wt, y = mpg)) + 
  geom_hline(yintercept = mean(mtcars$mpg), linewidth = 2, color = 'darkred') +
  geom_segment(aes(xend = wt, y = fitted(mod), yend = mpg), color = "darkred") +
  stat_smooth(method = 'lm', se = F, color = 'darkblue', linewidth = 2, 
    fullrange = TRUE, formula = 'y ~ x') +
  geom_point(size = 4) + 
  geom_point(size = 3, color = 'lightblue') + 
  ds4ling_bw_theme(base_size = 20, base_family = 'Times')
...
ggplot(mod, aes(x = fitted(mod), y = residuals(mod))) + 
  geom_hline(yintercept = 0, color = 'darkblue', linewidth = 2) + 
  annotate('text', x = 10, y = -1, lwd = 6, color = 'darkblue', 
    label = 'Best linear fit\nLeast squares estimate\n(sideways)') +
  geom_segment(aes(xend = fitted(mod), yend = 0), color = "darkred") +
  geom_point(size = 4) + 
  geom_point(size = 3, color = 'lightblue') + 
  ds4ling_bw_theme(base_size = 20, base_family = 'Times')
...
ggplot(mtcars, aes(x = wt, y = mpg)) + 
  ...
  geom_hline(yintercept = coef(mod)[1], lty = 2, linewidth = 0.8, color = 'black') + 
  geom_point(size = 4) + 
  geom_point(size = 3, color = 'lightblue') + 
  stat_smooth(method = 'lm', se = F, color = 'darkblue', linewidth = 2, 
    fullrange = TRUE, formula = 'y ~ x') +
...
ggplot(mtcars, aes(x = wt, y = mpg)) + 
  ...
  stat_smooth(method = 'lm', se = F, color = 'darkblue', 
    linewidth = 2, fullrange = TRUE, formula = 'y ~ x') + 
  xlim(0, 6) + 
  ds4ling_bw_theme(base_size = 20, base_family = 'Times')
...
ggplot(mtcars, aes(x = wt, y = mpg)) + 
  geom_segment(aes(x = 0, xend = 1, y = coef(mod)[1], yend = coef(mod)[1]),
    lty = 2, linewidth = 0.8, color = 'black') + 
  geom_segment(lty = 2, linewidth = 0.8, color = 'black', 
    aes(x = 1, xend = 1, y = coef(mod)[1], yend = coef(mod)[1] + coef(mod)[2])) + 
...
var_exp_p1 <- imperf_points1 %>% 
  ...
  geom_vline(xintercept = 0) + 
  geom_hline(yintercept = 0) + 
  geom_hline(yintercept = mean(imperf_points1$y), lty = 2, color = 'blue', 
    lwd = 1.5) +
  geom_abline(intercept = coef(imperf_mod)[1], slope = coef(imperf_mod)[2], 
...
var_exp_p1 + 
  annotate("text", x = 2.7, y = 2.58, label = "{", fontface = 5, lwd = 36) +
  annotate("text", x = 2.1, y = 2.6, label = "Total\ndeviation", 
    color = "red", fontface = 1, lwd = 6, hjust = 0.5)
```
...
var_exp_p1 + 
  annotate("text", x = 3.1, y = 2.3, label = "}", fontface = 5, lwd = 18) +
  annotate("text", x = 3.7, y = 2.25, color = "red", 
    label = "Predicted\ndeviation", fontface = 1, lwd = 6)
```
...
var_exp_p1 + 
  annotate("text", x = 2.8, y = 2.8, label = "{", fontface = 5, lwd = 18) +
  annotate("text", x = 2.2, y = 2.8, color = "red", 
    label = "Error\ndeviation", fontface = 1, lwd = 6)
```
...
var_exp_p1 + 
  annotate("text", x = 2.7, y = 2.58, label = "{", fontface = 5, lwd = 70) + 
  annotate("text", x = 2.1, y = 2.58, label = "Total\ndeviation", 
    color = "red", fontface = 2, lwd = 6, hjust = 0) + 
  annotate("text", x = 3.15, y = 2.3, label = "}", fontface = 5, lwd = 35) + 
  annotate("text", x = 3.25, y = 2.27, color = "red", 
    label = "Predicted\ndeviation", fontface = 2, lwd = 6, hjust = 0) + 
  annotate("text", x = 3.15, y = 2.8, label = "}", fontface = 5, lwd = 35) + 
  annotate("text", x = 3.25, y = 2.8, color = "red", 
    label = "Error\ndeviation", fontface = 2, lwd = 6, hjust = 0) + 
...
---
background-image: url(https://www.jvcasillas.com/media/rstats/memes/lm_office.png)
...
---
background-image: url(https://www.jvcasillas.com/media/rstats/memes/lm_tellmey.png)
...
ggplot(mtcars, aes(x = wt, y = mpg)) + 
  ...
  geom_segment(lwd = 1, lty = 3, color = "darkred", 
    aes(x = 0, xend = 1, y = round(coef(mod)[2] * 1 + coef(mod)[1], 2),
        yend = round(coef(mod)[2] * 1 + coef(mod)[1], 2))) + 
  geom_segment(lwd = 1, lty = 3, color = "darkred", 
    aes(x = 0, xend = 3, y = round(coef(mod)[2] * 3 + coef(mod)[1], 2), 
        yend = round(coef(mod)[2] * 3 + coef(mod)[1], 2))) + 
  geom_segment(lwd = 1, lty = 3, color = "darkred", 
    aes(x = 0, xend = 6, y = round(coef(mod)[2] * 6 + coef(mod)[1], 2), 
...
layout: false
class: inverse, middle
background-image: url(https://www.jvcasillas.com/media/rstats/memes/rstats_knowledge.png)
background-size: contain
