...
read_chunk(here::here("05_lm", "02_assumptions_diagnostics", "assets", 
...
writing up your results... .RUred[but it should be].
...
```{r}
#| label: tiktok1
t1_url <- "https://www.tiktok.com/@chelseaparlettpelleriti/video/7076276399505558827"
...
```{r}
#| label: pred_resid_corr_test_linear
